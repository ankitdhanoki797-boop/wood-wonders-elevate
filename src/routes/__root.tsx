...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { title: "Wood & Wonders — Premium Handcrafted Furniture in India" },
      {
        name: "description",
        content:
          "Solid wood sofas, beds, dining tables and modular kitchens, crafted in India and delivered nationwide.",
      },
